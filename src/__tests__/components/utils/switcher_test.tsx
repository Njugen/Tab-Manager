...
describe("Test <Switcher>", () => {
	test("Label is visible", () => {
		render(<Switcher label={mockLabel} value={false} onCallback={mockFn} />);
	...
	test("Label is not visible without props", () => {
		render(<Switcher value={false} onCallback={mockFn} />);
	...
	test("Toggline off", () => {
		render(<Switcher label={mockLabel} value={true} onCallback={mockFn} />);
