...
const TabItem = (props: iTabItem): JSX.Element => {
    ...
    return (
        <>
            <li className="bg-gray-100 border h-12 px-2 border-gray-100 hover:border-tbfColor-lightpurple hover:bg-tbfColor-lighterpurple hover:text-tbf-middlegrey2 transition-all ease-in duration-100 tab-item my-1 flex items-center justify-between">
