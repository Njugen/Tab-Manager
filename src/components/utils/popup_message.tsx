...
const PopupMessage = (props: iPopupMessage): JSX.Element => {
	...
	return (
		<div
			role="alert"
			className={`${styles.scroll_style} fixed top-0 flex ${popup_container_transparent_bg} justify-center items-center left-0 w-full h-screen z-[1000000]`}
		>
			<div className="p-10 bg-tbfColor-darkpurple rounded-lg drop-shadow-2xl text-center leading-7 text-md">
				...
				<p className="mb-8 text-white">{text}</p>
